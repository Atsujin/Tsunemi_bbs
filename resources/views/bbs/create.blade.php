...
<html>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">投稿フォーム</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">名前 タイトル 本文 は必ず入力して下さい<br>連続での投稿はしないで下さい</p>
    </div>
