...
<section class="text-gray-600 body-font">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <li class="mb-2 leading-relaxed">性格：ポジティブ、愚痴文句言わない、誰とでも仲良くできる方、細かい気配りできない、報連相が苦手、諦めが早い、完璧主義ではない 等々</li>
      <li class="mb-2 leading-relaxed">趣味、好きなもの：野球、ゴルフ、格闘技 の観戦。</li>
      ...
      <h1 class="title-font sm:text-xl text-3xl mb-4 font-medium text-gray-900">年表<h1>
        ...
        <p class="mb-2 leading-relaxed">
          私は、現在、電気通信工事の仕事をしております。約15年程しておりましたが、2023年頃から神経の病気を患いフラつく事が増えてきた為
          、高所作業のある現在の仕事をするのが難しくなりました。
          兄弟がプログラミングの仕事をしていたのもあり、プログラミングに興味を持ち、独学を始めました。
          ドットインストールでhtml cssの基礎を学び、Udemy等を使いphp laravelの勉強をしました。
          約半年独学し、今回このポートフォリオ作成に至りました。
        </p>
